  ...
  return (
    <div
      ...
      className={cn(
        ...
        isActive &&
          "ring-greyLight z-10 ring-1 ring-offset-white dark:ring-slate-300 dark:ring-offset-slate-950",
        className,
      )}
      {...props}
    >
      ...
      {hasFakeCaret && (
        <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
          <div className="animate-caret-blink bg-grey h-4 w-px duration-1000 dark:bg-slate-50" />
        </div>
      )}
    </div>
  );
